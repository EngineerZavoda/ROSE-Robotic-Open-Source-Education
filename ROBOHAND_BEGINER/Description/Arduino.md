...
**Начало работы**  
Для знакомства с платформой рекомендуется изучить [раздел проекта](https://github.com/EngineerZavoda/ROSE-Robotic-Open-Source-Education/tree/5424905c9d87c0db6538643a56385decddb705a3/ROBOHAND_BEGINER) и использовать доступные онлайн-ресурсы и проекты сообщества Arduino.
